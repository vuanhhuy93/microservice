#!/bin/sh
grepParams="service-discovery"
MESSAGE_DONE="deploy  service-discovery DONE"

JAR_PATH_FILE=/home/ubuntu/registry/service-discovery.jar
JAVA_OPS=" -Xmx2048m "
...
start(){
    ...
    if [ $t1 -eq 0  ];
    then
		nohup java -jar $JAVA_OPS  $JAR_PATH_FILE /tmp 2>> /dev/null >>/dev/null & echo $MESSAGE_DONE
